...
## Daten
Der von uns verwendete Datensatz umfasst EU-SILC-Daten von 2005 bis 2016. Der Datensatz für 2017 ist zum Zeitpunkt dieser Arbeit für Großbritannien noch nicht verfügbar. Aufgrund des Aufbaus von EU-SILC enthält er
...
besonders stark gestiegen sind und in London generell hoch sind. In den Regressionen ergeben sich allerdings für keine der Größen statistisch signifikante Effekte. Dies hängt höchstwahrscheinlich aber auch mit der Größe des Samples zusammen, das nicht genügend Beobachtungen für statistisch signifikante Koeffizienten bietet. Daher wollen wir im Folgenden noch auf die Jahre 2010 und 2011 eingehen. Für diese Jahre hat es im EU.Silc Datensatz eine feingliedrige Aufteilung der Regionen auf NUTS 2 Ebene. Zwar liegen diese Jahre weiter zurück, jedoch können die Zusammenhänge durch die Vergrößerung des Samples präziser geschätzt werden.
