...
shp<-readOGR("~/ineq_project/reports/GBR/shape_UK/NUTS_Level_2_January_2018_Full_Clipped_Boundaries_in_the_United_Kingdom.shp")
...
```{r, results='asis', echo=FALSE}
stargazer(spatial.gini.reg.nuts, spatial.mean.reg.nuts, title="Spatial Regression Results", align=TRUE)
```
